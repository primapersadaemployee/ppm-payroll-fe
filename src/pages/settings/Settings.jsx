...
import { CaretDown, Gear, MagnifyingGlass } from "phosphor-react";
import { SidebarComponent } from "../../components/layout/Sidebar";
import { Input, InputIcon } from "keep-react";
import BGCompany from "/setting-company.png";
import BGPayroll from "/setting-payroll.png";
import BGSchedule from "/setting-schedule.png";
import BGOvertime from "/setting-overtime.png";
import BGLocation from "/setting-location.png";
import BGProfile from "/setting-profile.png";
      ...
      menu: [
        {
          id: 1,
          title: "Jadwal Kerja",
          desc: "Atur Jadwal Kerja Karyawan",
          image: BGSchedule,
        ...
        },
        {
          id: 2,
          title: "Lembur",
          desc: "Atur Lembur Karyawan",
          image: BGOvertime,
          link: "/settings/overtime",
        },
        {
          id: 3,
          title: "Lokasi Kantor",
          desc: "Lokasi Presensi Karyawan",
          image: BGLocation,
          link: "/settings/attendance-location",
        },
      ],
    },
    {
      ...
      menu: [
        {
          id: 1,
          title: "Profilku",
          desc: "Atur Profil dan ubah password",
          image: BGProfile,
      ...
      <div className="p-2 lg:p-4 w-full flex-1 overflow-hidden">
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <div className="flex justify-between items-center">
            <h1 className="text-2xl lg:text-3xl font-medium">Pengaturan</h1>
