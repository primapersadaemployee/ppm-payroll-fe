...
import TableSalarySlip from "../../components/ui/table/TableSalarySlip";
import TableCompanyAccount from "../../components/ui/table/TableCompanyAccount";
    ...
    <div className="flex gap-2 lg:gap-4 font-poppins p-2 lg:p-4 min-h-screen text-[#455468]">
      ...
      <div className="p-2 lg:p-4 w-full flex-1 overflow-hidden">
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <nav className="text-xs sm:text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>/</span>
              <span>{option === 1 ? "Slip Gaji" : "Rekening Perusahaan"}</span>
            </div>
          </nav>
        ...
        `}
            ...
            {option === 1 ? <TableSalarySlip /> : <TableCompanyAccount />}
          </div>
        </div>
      </div>
    </div>
