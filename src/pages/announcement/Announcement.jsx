...
import TableAnnouncement from "../../components/ui/table/TableAnnouncement";
        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <nav className="text-xs sm:text-sm">
            <div className="flex items-center gap-2">
              <Notification size={16} weight="fill" />
              <span>/</span>
          ...
          <div className="flex justify-between items-center">
            <h1 className="text-2xl lg:text-3xl font-medium">Pengumuman</h1>
