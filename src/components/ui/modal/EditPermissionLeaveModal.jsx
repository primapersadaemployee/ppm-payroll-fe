...
export default function EditPermissionLeaveModal({ permissionLeave }) {
  const {
    formData,
    isFirstModalOpen,
    setIsFirstModalOpen,
  ...
  const handleModalSuccess = () => {
    const success = handleEditPermissionLeave();
    if (success) {
        ...
        <ModalHeader className="py-6 flex flex-col justify-center gap-8">
          <div className="flex justify-between items-center">
            ...
            <ModalDescription className="hidden">
              Silahkan isi data izin dibawah ini.
            </ModalDescription>
          ...
          <form
            id="edit-permission-leave"
            name="edit-permission-leave"
