...
export default function EditPermissionLeaveModal({ unpaidLeave }) {
  const {
    formData,
    isFirstModalOpen,
    setIsFirstModalOpen,
  ...
  const handleModalSuccess = () => {
    const success = handleEditUnpaidLeave();
    if (success) {
  ...
  return (
    <BaseModal
      ...
      title="Ubah Pengajuan Unpaid Leave"
      onSave={handleModalSuccess}
    >
      <form
        id="edit-unpaid-leave"
        name="edit-unpaid-leave"
