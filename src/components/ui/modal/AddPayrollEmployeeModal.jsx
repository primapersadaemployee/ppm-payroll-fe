...
export default function AddPayrollEmployeeModal() {
  ...
  return (
    <BaseModal
      ...
      onSave={() => {
        const success = handleAddPayrollEmployee();
        if (success) {
    ...
    >
      <div className="p-6 rounded-3xl border text-[#455468] border-gray-100 flex flex-col gap-5 font-poppins">
        ...
        <div>
          <div className="block text-sm font-medium mb-2">Pilih Slip Gaji</div>
          <div className="flex gap-4">
            <label htmlFor="gajiBulanan" className="flex items-center gap-2">
              <Checkbox
                id="gajiBulanan"
                name="gajiBulanan"
        ...
        <div>
          <label htmlFor="gajiPokok" className="block text-sm font-medium mb-2">
        ...
        <div>
          <label htmlFor="koperasi" className="block text-sm font-medium mb-2">
            Potongan Koperasi
          </label>
          <Input
            id="koperasi"
        ...
        <div>
          ...
          >
            <SelectAction id="metodePerhitunganPph" name="metodePerhitunganPph">
        ...
        <div>
          <label htmlFor="jaminanHariTua" className="flex items-center gap-2">
            <Switch
              id="jaminanHariTua"
              name="jaminanHariTua"
              checked={formData.jaminanHariTua === "Ya"}
              onCheckedChange={(checked) =>
                handleInputChange("jaminanHariTua", checked ? "Ya" : "Tidak")
              }
              className={`${
        ...
        <div>
          <label htmlFor="jaminanPensiunan" className="flex items-center gap-2">
            <Switch
              id="jaminanPensiunan"
              name="jaminanPensiunan"
              checked={formData.jaminanPensiunan === "Ya"}
              onCheckedChange={(checked) =>
                handleInputChange("jaminanPensiunan", checked ? "Ya" : "Tidak")
              }
              className={`${
                formData.jaminanPensiunan === "Ya" ? "bg-primary" : ""
              }`}
            />
            <span className="text-sm">Karyawan memakai jaminan pensiunan</span>
          </label>
        </div>
        <div>
          <label
