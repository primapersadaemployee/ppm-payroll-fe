...
export default function AddSalarySlipModal() {
  const {
    formData,
    isFirstModalOpen,
    setIsFirstModalOpen,
  ...
  const handleModalSuccess = () => {
    const success = handleAddSalarySlip();
    if (success) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <label htmlFor="periode" className="block text-sm font-medium mb-2">
            Periode
          </label>
          <Select
            name="periode"
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => handleInputChange("lamaPeriode", value)}
          >
        ...
        <div>
          <label
            ...
            className="block text-sm font-medium mb-2"
          >
            Untuk komponen pendapatan tergantung kehadiran, berapa hari absensi
            terakhir yang masuk hitungan
          </label>
          <Input
            id="absensiTerakhir"
            type="number"
