    ...
    <div className="bg-white rounded-2xl py-4 lg:py-6 shadow-sm border border-gray-100">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center lg:justify-between gap-4 mb-6">
        <div className="flex items-center gap-4 px-4 lg:px-6">
          <h2 className="text-lg font-medium">Daftar Lokasi Kantor</h2>
        </div>
      ...
      <div className="overflow-x-auto">
        <div className="space-y-4">
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      <Button
                        ...
                        title="Edit"
                        onClick={() =>
                          handleEditAttendanceLocation(location.id)
                        }
                      >
                        <span>
                          <NotePencil size={19} />
          ...
          <ConfirmModal
            ...
            title="Tambah Lokasi Kerja Berhasil"
          ...
          <ConfirmModal
            ...
            title="Ubah Lokasi Perusahaan Berhasil"
            description="Lokasi Perusahaan berhasil diubah."
            onClick={() => {
              setIsEditSecondModalOpen(false);
              resetEditForm();
            }}
