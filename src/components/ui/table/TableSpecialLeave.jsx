...
import ConfirmEditSpecialLeaveModal from "../modal/ConfirmEditSpecialLeaveModal";
import { format } from "date-fns";
import AddSpecialLeaveModal from "../modal/AddSpecialLeaveModal";
import ConfirmAddSpecialLeaveModal from "../modal/ConfirmAddSpecialLeaveModal";
...
export default function TableSpecialLeave() {
  ...
  const { setSpecialLeave, setIsFirstModalOpen } = useEditSpecialLeaveStore();
    ...
    <div className="bg-white rounded-2xl py-4 lg:py-6 shadow-sm border border-gray-100">
      ...
      <div className="overflow-x-auto">
        <div className="space-y-4">
          ...
          <ConfirmAddSpecialLeaveModal />
          <EditSpecialLeaveModal specialLeaves={SpecialLeaveData} />
          <ConfirmEditSpecialLeaveModal />
          {/* Pagination */}
          {totalPages > 1 && (
