    ...
    <div className="bg-white rounded-2xl py-4 lg:py-6 shadow-sm border border-gray-100">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center lg:justify-between gap-4 mb-6">
        <div className="flex items-center gap-4 px-4 lg:px-6">
          <h2 className="text-lg font-medium">Daftar Slip Gaji</h2>
        </div>
      ...
      <div className="overflow-x-auto">
        <div className="space-y-4">
            ...
            <TableBody>
              {paginatedSalarySlip.length > 0 ? (
                paginatedSalarySlip.map((slip) => (
                  ...
                  >
                    <TableCell className="text-center">{slip.id}</TableCell>
                    <TableCell className="text-center">{slip.nama}</TableCell>
                    ...
                    <TableCell className="text-center">
                      <Button
                        ...
                        title="Edit"
                        onClick={() => handleEditSalarySlip(slip.id)}
                      >
                        <span>
                          <NotePencil size={19} />
                        </span>
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-8">
                    <div className="flex flex-col items-center gap-2">
                      <p className="font-medium">Belum ada data slip gaji.</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}
          ...
          <ConfirmModal
            ...
            title="Tambah Slip Gaji Berhasil"
            description="Slip Gaji berhasil ditambahkan."
            onClick={() => {
              setIsSecondModalOpen(false);
              resetForm();
            }}
          ...
          <ConfirmModal
            ...
            title="Ubah Slip Gaji Berhasil"
            description="Slip Gaji berhasil diubah."
            onClick={() => {
              setIsEditSecondModalOpen(false);
              resetEditForm();
            }}
